...
# ----------------Model for ablation study Dual Input-------------------------
class ChannelAttention_dual_input(nn.Module):
    """
    This class implements a channel attention mechanism that computes attention weights
    based on the context and prior knowledge.
...
class ProposedModel_dual_input(nn.Module):
    """
    Model removed the dual input mechanism.
    ...
    def __init__(self, input_size, hidden_size, output_size, num_layers=1):
        ...
        # Channel attention layer
        self.channel_attention = ChannelAttention_dual_input(hidden_size)
...
# remove dual-input mechanism
def proposed_model_train_dual(
    model,
    train_dataloader,
    val_dataloader,
    optimizer,
    ...
    """
    Train the model that removes the dual-input mechanism (ablation study: dual-input).
...
def proposed_model_eval_dual(
    ...
    """
    Evaluate the model that removes the dual-input mechanism (ablation study: dual-input).
